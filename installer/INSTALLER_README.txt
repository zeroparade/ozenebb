...
The installer downloads the pinned BepInEx IL2CPP x64 build when needed, then installs the complete sharded voice pack. Later updates download only shards whose content hashes changed.
...
F9 downloads and installs changed voice-pack shards.
